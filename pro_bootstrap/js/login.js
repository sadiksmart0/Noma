...
// 	let userPass = document.getElementById("_password").value;
...
//   //Email sent.
//	window.alert("An email has been sent to you for confirmation");
//		   
...
// }
 ...
 function signOut(){
   ...
   // Sign-out successful.
	window.location.replace('C:/Users/Sadiksmart/Desktop/pro_bootstrap/index.html'); 	
 }).catch(function(error) {
   // An error happened.
 });
 }
